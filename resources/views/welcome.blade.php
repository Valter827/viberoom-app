...
<body class="h-full font-sans antialiased">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-[#1E1F22] text-gray-100 px-6">
        ...
        <img src="{{ asset('images/logo-emblem.png') }}" alt="VibeRoom" class="w-32 h-32 rounded-full object-contain mb-6 shadow-lg">
        ...
        <div class="flex flex-col sm:flex-row gap-4 w-full max-w-xs sm:max-w-none justify-center">
            ...
            <a href="{{ route('register') }}"
               class="px-8 py-3 rounded-lg bg-[#2B2D31] hover:bg-[#313338] text-gray-100 font-semibold text-center border border-gray-700 transition-colors">
                Регистрация
            </a>
        </div>
    </div>
